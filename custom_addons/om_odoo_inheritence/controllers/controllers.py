...
class OmOdooInheritence(http.Controller):
    ...
    def list(self, **kw):
        return http.request.render(
            "om_odoo_inheritence.listing",
            {
                "root": "/om_odoo_inheritence/om_odoo_inheritence",
                "objects": http.request.env[
                    "om_odoo_inheritence.om_odoo_inheritence"
                ].search([]),
            },
        )

    @http.route(
        '/om_odoo_inheritence/om_odoo_inheritence/objects/<model("om_odoo_inheritence.om_odoo_inheritence"):obj>',
        auth="public",
    )
    def object(self, obj, **kw):
        return http.request.render("om_odoo_inheritence.object", {"object": obj})
